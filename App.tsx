...
const ResultCard: React.FC<{ title: string; value: string; highlight?: boolean }> = ({ title, value, highlight = false }) => (
    <div className={`p-4 rounded-lg flex flex-col items-center justify-center text-center ${highlight ? 'bg-brand-red-600 text-white' : 'bg-white shadow-sm'}`}>
        <span className={`text-sm ${highlight ? 'text-red-100' : 'text-gray-500'}`}>{title}</span>
        ...
        <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
            <main className="max-w-4xl mx-auto">
                <header className="text-center mb-8">
                    <h1 className="text-4xl font-bold text-brand-red-600">Simulador de Juros Compostos</h1>
                ...
                <div className="bg-white p-6 sm:p-8 rounded-xl shadow-md">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="flex items-center rounded-md border border-gray-300 focus-within:ring-2 focus-within:ring-brand-red-500 focus-within:border-brand-red-500">
                    ...
                    <div className="mt-6 flex items-center justify-between">
                        <button onClick={handleCalculate} className="bg-brand-red-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-brand-red-700 transition duration-300 shadow-md">
                            Calcular
                        </button>
                        <button onClick={handleClear} className="text-gray-600 hover:text-brand-red-600 font-medium transition duration-300">
                            Limpar
                        </button>
                    </div>
                </div>
                ...
                {result && (
                    <div id="result-section" className="mt-8 space-y-8">
                        <div className="text-center">
                            <h2 className="text-3xl font-bold text-brand-red-600">Resultado da Simulação</h2>
                        </div>
